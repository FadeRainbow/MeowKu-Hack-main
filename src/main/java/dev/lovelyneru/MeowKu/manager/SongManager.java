...
import dev.lovelyneru.MeowKu.util.Globals;
import dev.lovelyneru.MeowKu.util.songs.DontStop;
import dev.lovelyneru.MeowKu.util.songs.FireBall;
import dev.lovelyneru.MeowKu.util.songs.HotelRoom;

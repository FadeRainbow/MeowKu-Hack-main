package dev.lovelyneru.MeowKu.features;
...
import dev.lovelyneru.MeowKu.manager.TextManager;
...
public class Feature
    ...
    public TextManager renderer = MeowKu.textManager;
    private String name;
    ...
    public  Setting register(Setting setting) {
        ...
        if (this instanceof Module && Feature.mc.currentScreen instanceof MeowKuGui) {
            MeowKuGui.getInstance().updateModule((Module) this);
        }
        return setting;
    }

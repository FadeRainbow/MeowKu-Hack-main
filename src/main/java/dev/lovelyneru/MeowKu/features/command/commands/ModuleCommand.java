...
import dev.lovelyneru.MeowKu.manager.ConfigManager;
...
public class ModuleCommand
    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : MeowKu.moduleManager.getCategories()) {
                String modules = category.getName() + ": ";
                for (Module module1 : MeowKu.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = MeowKu.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = MeowKu.moduleManager.getModuleByName(commands[0]);
            if (module == null) {

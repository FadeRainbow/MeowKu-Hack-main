...
public class NameTags
    ...
    private final Setting<Boolean> NCRainbow = this.register(new Setting<Object>("Text-Rainbow", Boolean.valueOf(true), v -> this.textcolor.getValue()));

package dev.lovelyneru.MeowKu.features.modules;
...
public class Module
    ...
    public void enable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(MeowKu.commandManager.getClientMessage() + " " + ChatFormatting.GREEN + this.getDisplayName() + " toggled on.");
    ...
    public void disable() {
        ...
        if (HUD.getInstance().notifyToggles.getValue().booleanValue()) {
            TextComponentString text = new TextComponentString(MeowKu.commandManager.getClientMessage() + " " + ChatFormatting.RED + this.getDisplayName() + " toggled off.");
            Module.mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(text, 1);
        }
        this.onToggle();
        this.onDisable();
    ...
    public void setDisplayName(String name) {
        Module module = MeowKu.moduleManager.getModuleByDisplayName(name);
        Module originalModule = MeowKu.moduleManager.getModuleByName(name);

...
import dev.lovelyneru.MeowKu.features.modules.combat.AutoCrystal;
...
import static dev.lovelyneru.MeowKu.MeowKu.*;
...
public class PistonCrystal extends Module {
  ...
  public void onTick() {
    try {
      ...
      this.debug_stage = 3;
      boolean doTrap = (this.trap.getValue() == mode.Force || (this.trap.getValue() == mode.Smart && holeManager.isSafe(mc.player.getPosition()) && this.b_piston.getY() == mc.player.getPosition().getY() + 1));

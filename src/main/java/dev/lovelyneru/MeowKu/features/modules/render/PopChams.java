...
import dev.lovelyneru.MeowKu.util.NordTessellator;
import dev.lovelyneru.MeowKu.util.TotemPopCham;
...
public class PopChams extends Module
{
    ...
    public PopChams() {
        super("PopChams", "wow yo are pop !", Category.RENDER, true, false, false);

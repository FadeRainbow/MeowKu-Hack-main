...
public class RenderUtil implements Util {
    ...
    public static void drawTextz(final AxisAlignedBB pos, final String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-(MeowKu.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
        MeowKu.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        GlStateManager.popMatrix();
    }

    public static void drawSexyBoxStayIsRetardedFuckYouESP(final AxisAlignedBB a, final Color boxColor, final Color outlineColor, final float lineWidth, final boolean outline, final boolean box, float alpha, final float scale, final float slab) {

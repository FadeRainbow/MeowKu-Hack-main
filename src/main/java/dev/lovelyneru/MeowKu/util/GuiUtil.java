...
public class GuiUtil {
    public static void drawString(String paramString, float paramFloat1, float paramFloat2, int paramInt) {
        if (MeowKu.moduleManager.getModuleByName("CustomFont").isEnabled()) {
            MeowKu.fontRenderer.drawStringWithShadow(paramString, paramFloat1, paramFloat2, paramInt);
        } else {
    ...
    public static void drawString(String paramString, int paramInt1, int paramInt2, int paramInt3) {
        if (MeowKu.moduleManager.getModuleByName("CustomFont").isEnabled()) {
            MeowKu.fontRenderer.drawStringWithShadow(paramString, paramInt1, paramInt2, paramInt3);
        } else {
    ...
    public static String getCFont() {
        return MeowKu.fontRenderer.getFont().getFamily();
    }
    ...
    public static int getHeight() {
        return MeowKu.moduleManager.getModuleByName("CustomFont").isEnabled() ? MeowKu.fontRenderer.getHeight() : MeowKu.fontRenderer.getHeight();
    }
    ...
    public static void drawCenteredString(String paramString, int paramInt1, int paramInt2, int paramInt3) {
        if (MeowKu.moduleManager.getModuleByName("CustomFont").isEnabled()) {
            MeowKu.fontRenderer.drawStringWithShadow(paramString, (paramInt1 - MeowKu.fontRenderer.getStringWidth(paramString) / 2), paramInt2, paramInt3);
        } else {
            Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(paramString, (paramInt1 - MeowKu.fontRenderer.getStringWidth(paramString) / 2), paramInt2, paramInt3);
        }
    }
}
